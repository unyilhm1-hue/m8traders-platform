...
export function WelcomeCard({ userName = 'Trader' }: WelcomeCardProps) {
    ...
    return (
        <div className="relative p-8 rounded-2xl bg-gradient-to-br from-[var(--bg-secondary)]/90 to-[var(--bg-tertiary)]/50 border border-[var(--bg-tertiary)] overflow-hidden shadow-2xl group">
            {/* Ambient Background */}
            ...
            <div className="relative z-10 flex flex-col items-start gap-4">
                {/* Header Section */}
                <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--accent-primary)]/10 text-[var(--accent-primary)] text-xs font-semibold mb-3 border border-[var(--accent-primary)]/20">
                ...
                <div className="max-w-2xl">
                    <blockquote className="text-lg md:text-xl text-[var(--text-secondary)] italic font-light leading-relaxed">
                        "{quote}"
                    </blockquote>
                </div>
                ...
                <div className="mt-4">
                    <a
                        href="/challenges"
                        className="group/btn relative inline-flex items-center gap-2 px-8 py-3 bg-[var(--accent-primary)] text-white font-bold rounded-xl overflow-hidden hover:shadow-[0_0_20px_rgba(0,201,183,0.4)] transition-all duration-300 transform hover:-translate-y-0.5"
                    >
